	...
	registerAction2(class NewChatEditorAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('hify.chat.newChat.label', "New Chat"),
				icon: Codicon.plus,
				f1: false,
	...
	registerAction2(class NewChatAction extends EditingSessionAction {
		constructor() {
			super({
				...
				title: localize2('hify.chat.newEdits.label', "New Chat"),
	...
	registerAction2(class UndoChatEditInteractionAction extends EditingSessionAction {
		constructor() {
			super({
				...
				title: localize2('hify.chat.undoEdit.label', "Undo Last Request"),
				category: CHAT_CATEGORY,
	...
	registerAction2(class RedoChatEditInteractionAction extends EditingSessionAction {
		constructor() {
			super({
				...
				title: localize2('hify.chat.redoEdit.label', "Redo Last Request"),
				category: CHAT_CATEGORY,
				icon: Codicon.redo,
	...
	registerAction2(class RedoChatCheckpoints extends EditingSessionAction {
		constructor() {
			super({
				...
				title: localize2('hify.chat.redoEdit.label2', "Redo"),
				tooltip: localize2('hify.chat.redoEdit.tooltip', "Reapply discarded workspace changes and chat"),
				category: CHAT_CATEGORY,
				precondition: ContextKeyExpr.and(ChatContextKeys.chatEditingCanRedo, ChatContextKeys.enabled),
				f1: true,
				menu: [{
