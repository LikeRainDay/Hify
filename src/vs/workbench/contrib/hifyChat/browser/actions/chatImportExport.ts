...
const defaultFileName = 'hify.chat.json';
const filters = [{ name: localize('hify.chat.file.label', "Chat Session"), extensions: ['json'] }];
	...
	registerAction2(class ExportChatAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('hify.chat.export.label', "Export Chat..."),
	...
	registerAction2(class ImportChatAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('hify.chat.import.label', "Import Chat..."),
				category: CHAT_CATEGORY,
				precondition: ChatContextKeys.enabled,
				f1: true,
			});
