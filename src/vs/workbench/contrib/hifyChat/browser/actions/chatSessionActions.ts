...
export class OpenChatSessionInNewWindowAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize('hify.chat.openSessionInNewWindow.label', "Open Chat in New Window"),
			category: CHAT_CATEGORY,
			f1: false,
		});
	}
...
export class OpenChatSessionInNewEditorGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize('hify.chat.openSessionInNewEditorGroup.label', "Open Chat to the Side"),
			category: CHAT_CATEGORY,
			f1: false,
		});
	}
...
export class OpenChatSessionInSidebarAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize('hify.chat.openSessionInSidebar.label', "Open Chat in Sidebar"),
			category: CHAT_CATEGORY,
			f1: false,
		});
	}
...
export class ChatSessionsGettingStartedAction extends Action2 {
	static readonly ID = 'hify.chat.sessions.gettingStarted';

	constructor() {
		super({
			id: ChatSessionsGettingStartedAction.ID,
			title: nls.localize2('hify.chat.sessions.gettingStarted.action', "Getting Started with Chat Sessions"),
