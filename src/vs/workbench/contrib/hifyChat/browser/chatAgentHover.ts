...
export class ChatAgentHover extends Disposable {
	...
	constructor(
		...
		const hoverElement = dom.h(
			'.hify-chat-agent-hover@root',
			[
				dom.h('.hify-chat-agent-hover-header', [
					dom.h('.hify-chat-agent-hover-icon@icon'),
					dom.h('.hify-chat-agent-hover-details', [
						dom.h('.hify-chat-agent-hover-name@name'),
						dom.h('.hify-chat-agent-hover-extension', [
							dom.h('.hify-chat-agent-hover-extension-name@extensionName'),
							dom.h('.hify-chat-agent-hover-separator@separator'),
							dom.h('.hify-chat-agent-hover-publisher@publisher'),
						]),
					]),
				]),
				dom.h('.hify-chat-agent-hover-warning@warning'),
				dom.h('span.hify-chat-agent-hover-description@description'),
			]);
		...
		this.publisherName = dom.$('span.hify-chat-agent-hover-publisher-name');
		dom.append(
