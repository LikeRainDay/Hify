...
export class ChatCodeCitationContentPart extends Disposable implements IChatContentPart {
	...
	constructor(
		...
		const elements = dom.h('.hify-chat-code-citation-message@root', [
			dom.h('span.hify-chat-code-citation-label@label'),
			dom.h('.hify-chat-code-citation-button-container@button'),
		]);
