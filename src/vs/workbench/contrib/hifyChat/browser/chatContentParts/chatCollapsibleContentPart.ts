...
export abstract class ChatCollapsibleContentPart extends Disposable implements IChatContentPart {
	...
	protected init(): HTMLElement {
		...
		const buttonElement = $('.hify-chat-used-context-label', undefined);
		...
		this._domNode = $('.hify-chat-used-context', undefined, buttonElement);
		...
		this._register(autorun(r => {
			...
			this._domNode?.classList.toggle('hify-chat-used-context-collapsed', !value);
