...
export const enum TerminalToolConfirmationStorageKeys {
	TerminalAutoApproveWarningAccepted = 'hify.chat.tools.terminal.autoApprove.warningAccepted'
}
...
export class ChatTerminalToolConfirmationSubPart extends BaseChatToolInvocationSubPart {
	...
	constructor(
		...
		const elements = h('.hify-chat-confirmation-message-terminal', [
			h('.hify-chat-confirmation-message-terminal-editor@editor'),
			h('.hify-chat-confirmation-message-terminal-disclaimer@disclaimer'),
		]);
