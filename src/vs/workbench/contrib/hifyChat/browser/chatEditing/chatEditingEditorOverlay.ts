...
class ChatEditorOverlayWidget extends Disposable {
	...
	constructor(
		...
		this._domNode.classList.add('hify-chat-editor-overlay-widget');
		...
		progressNode.classList.add('hify-chat-editor-overlay-progress');
		...
		this._toolbarNode.classList.add('hify-chat-editor-overlay-toolbar');
...
class ChatEditingOverlayController {
	...
	constructor(
		...
		this._domNode.classList.add('hify-chat-editing-editor-overlay');
...
export class ChatEditingEditorOverlay implements IWorkbenchContribution {
	...
	static readonly ID = 'hify.chat.edits.editorOverlay';
