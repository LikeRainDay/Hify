...
export class InlineAnchorWidget extends Disposable {
	...
	public static readonly className = 'hify-chat-inline-anchor-widget';
...
registerAction2(class AddFileToChatAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineResourceAnchor.addFileToChat';
...
registerAction2(class CopyResourceAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineResourceAnchor.copyResource';
...
registerAction2(class OpenToSideResourceAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineResourceAnchor.openToSide';
...
registerAction2(class GoToDefinitionAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineSymbolAnchor.goToDefinition';
...
registerAction2(class GoToTypeDefinitionsAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineSymbolAnchor.goToTypeDefinitions';
...
registerAction2(class GoToImplementations extends Action2 {
	...
	static readonly id = 'hify.chat.inlineSymbolAnchor.goToImplementations';
...
registerAction2(class GoToReferencesAction extends Action2 {
	...
	static readonly id = 'hify.chat.inlineSymbolAnchor.goToReferences';
