...
export class SessionsViewPane extends ViewPane {
	...
	protected override renderBody(container: HTMLElement): void {
		...
		this.treeContainer = DOM.append(container, DOM.$('.hify-chat-sessions-tree-container'));
		// Create message element for empty state
		this.messageElement = append(container, $('.hify-chat-sessions-message'));
		...
		const items: IGettingStartedItem[] = [
			{
				...
				commandId: 'hify.chat.sessions.gettingStarted'
			},
			{
				id: 'learn-more',
