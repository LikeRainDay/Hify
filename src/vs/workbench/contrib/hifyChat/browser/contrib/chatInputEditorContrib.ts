...
const placeholderDecorationType = 'hify-chat-session-detail';
const slashCommandTextDecorationType = 'hify-chat-session-text';
const variableTextDecorationType = 'hify-chat-variable-text';
...
class InputEditorDecorations extends Disposable {
	...
	private async updateInputEditorDecorations() {
		...
		if (!inputValue) {
			...
			if (this.configurationService.getValue<boolean>('hify.chat.emptyChatState.enabled')) {
