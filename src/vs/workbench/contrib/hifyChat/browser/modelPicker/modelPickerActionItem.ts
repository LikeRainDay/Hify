		...
		getActions: () => {
			...
			if (
				...
				additionalActions.push({
					id: 'manageModels',
					label: localize('hify.chat.manageModels', "Manage Models..."),
					enabled: true,
					tooltip: localize('hify.chat.manageModels.tooltip', "Manage language models"),
					class: undefined,
					run: () => {
			...
			if (chatEntitlementService.entitlement === ChatEntitlement.Free) {
				additionalActions.push({
					id: 'moreModels',
					label: localize('hify.chat.moreModels', "Add Premium Models"),
					enabled: true,
					tooltip: localize('hify.chat.moreModels.tooltip', "Add premium models"),
					class: undefined,
					run: () => {
...
export class ModelPickerActionItem extends ActionWidgetDropdownActionViewItem {
	constructor(
		...
		const actionWithLabel: IAction = {
			...action,
			label: currentModel?.metadata.name ?? localize('hify.chat.modelPicker.label', "Pick Model"),
			tooltip: localize('hify.chat.modelPicker.label', "Pick Model"),
			run: () => { }
		};
	...
	protected override renderLabel(element: HTMLElement): IDisposable | null {
		...
		domChildren.push(dom.$('span.hify-chat-model-label', undefined, this.currentModel?.metadata.name ?? localize('hify.chat.modelPicker.label', "Pick Model")));
	...
	override render(container: HTMLElement): void {
		...
		container.classList.add('hify-chat-modelPicker-item');
	}
}
