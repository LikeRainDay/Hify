...
// example URL: code-oss:hify-chat-prompt/install?url=https://gist.githubusercontent.com/aeschli/43fe78babd5635f062aef0195a476aad/raw/dfd71f60058a4dd25f584b55de3e20f5fd580e63/filterEvenNumbers.prompt.md
...
export class PromptUrlHandler extends Disposable implements IWorkbenchContribution, IURLHandler {
	...
	async handleURL(uri: URI): Promise<boolean> {
		...
		switch (uri.path) {
			case 'hify-chat-prompt/install':
				promptType = PromptsType.prompt;
				break;
			case 'hify-chat-instructions/install':
				promptType = PromptsType.instructions;
				break;
			case 'hify-chat-mode/install':
