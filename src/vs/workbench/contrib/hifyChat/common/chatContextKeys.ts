...
export namespace ChatContextKeys {
	...
	export const chatToolGroupingThreshold = new RawContextKey<number>('hify.chat.toolGroupingThreshold', 0, { type: 'number', description: localize('chatToolGroupingThreshold', "The number of tools at which we start doing virtual grouping.") });
