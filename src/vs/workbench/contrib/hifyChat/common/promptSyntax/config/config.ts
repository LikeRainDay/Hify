...
export namespace PromptsConfig {
	 ...
	 */
	export const KEY = 'hify.chat.promptFiles';

	/**
	 * Configuration key for the locations of reusable prompt files.
	 */
	export const PROMPT_LOCATIONS_KEY = 'hify.chat.promptFilesLocations';

	/**
	 * Configuration key for the locations of instructions files.
	 */
	export const INSTRUCTIONS_LOCATION_KEY = 'hify.chat.instructionsFilesLocations';
	/**
	 * Configuration key for the locations of mode files.
	 */
	export const MODE_LOCATION_KEY = 'hify.chat.modeFilesLocations';

	/**
	 * Configuration key for prompt file suggestions.
	 */
	export const PROMPT_FILES_SUGGEST_KEY = 'hify.chat.promptFilesRecommendations';
	 ...
	 */
	export const USE_AGENT_MD = 'hify.chat.useAgentsMdFile';
