...
export const BACKGROUND_COLOR: ColorIdentifier = registerColor(
	...
	localize('hify.chat.prompt.frontMatter.background.description', "Background color of a Front Matter header block."),
);
...
export const INACTIVE_BACKGROUND_COLOR: ColorIdentifier = registerColor(
	...
	localize('hify.chat.prompt.frontMatter.inactiveBackground.description', "Background color of an inactive Front Matter header block."),
);
